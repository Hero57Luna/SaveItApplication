...
public class TambahPemasukan extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        datePicker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                datePickerDialog = DatePickerDialog.newInstance(TambahPemasukan.this, Year, Month, Day);
                ...
                datePickerDialog.setOnCancelListener(new DialogInterface.OnCancelListener() {
                    ...
                    public void onCancel(DialogInterface dialog) {
                        Toast.makeText(TambahPemasukan.this, "Datepicker Canceled", Toast.LENGTH_SHORT).show();
                    }
                });
        ...
        simpan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DatabaseHelper databaseHelper = new DatabaseHelper(TambahPemasukan.this);
